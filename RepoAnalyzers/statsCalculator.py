...
tool=pandas.read_csv("Tool_avg_isse.csv", sep=',', encoding="utf-8",
                     error_bad_lines="ignore")

applied=pandas.read_csv("Applied_avg_issue.csv", sep=',', encoding="utf-8",
                        error_bad_lines="ignore")


# aiml= tool["Avg_NBReviewCount"].tolist() + applied["Avg_NBReviewCount"].tolist()

noaiml=pandas.read_csv("NoAIML_avg_issue.csv", sep=',', encoding="utf-8",
                       error_bad_lines="ignore")
print(applied.columns)
fvalue, pvalue = stats.f_oneway(applied['Duration'], tool['Duration'], noaiml['Duration'])
